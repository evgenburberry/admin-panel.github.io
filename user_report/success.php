...
while ($result = mysqli_fetch_array($nastr)) {
		...
		$reportnumb = $result['reportnumb'];
    }


$frd = json_decode(file_get_contents('https://api.vk.com/method/users.get?v=5.95&user_ids='.$reportid.'&fields=counters,country,sex,city,photo_200&access_token='.$admintoken));
