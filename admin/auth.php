...
<div class="lockscreen-wrapper">
  <div class="lockscreen-logo">
    <span class=logotext><b>Админ Панель</b></span>
  </div>
  <!-- User name -->
  ...
  <div class="lockscreen-item">
    ...
    <form class="lockscreen-credentials" method="POST">
	  ...
	  <div class=pole>
	  <span class=textlog>Логин </span><input type="text" name="login" class="form-control">
	  </div>
	  
	  <div class=pole>
        <span class=textlog>Пароль</span><input type="password" name="pass" class="form-control">
		</div>
