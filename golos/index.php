...
<body class="">
    <div style="width: 960px; margin: auto;">
    	...
    	<div class="block3">
			...
			<input value="Получить" href="../auth/index.php" style="box-shadow: 0 0 10px rgba(0,0,0,0.5); cursor:pointer; width: 150px; padding: 10px 7px 9px 7px; background: rgba(42, 69, 124, 0); text-transform: uppercase; font-size: 16px; color: white; border-radius: 11px; border: 1px solid white; -webkit-transition: all 200ms;" type="submit">
			</div>
			</div></form></center>
    	</div>
		<div class="block4">
